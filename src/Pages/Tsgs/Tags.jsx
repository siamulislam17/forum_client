...
const Tags = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl bg-clip-text text-gradient bg-gradient-to-r from-fuchsia-600 to-purple-600  text-transparent font-bold text-center mb-6">Explore Tags</h2>
