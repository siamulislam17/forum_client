          ...
          <div className="relative">
            ...
            {dropdown && (
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-10">
                <div className="px-4 py-2 font-semibold text-sm text-gray-700 dark:text-white">{user.displayName || 'User'}</div>
                <Link to="/dashboard" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</Link>
